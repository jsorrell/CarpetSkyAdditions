...
public class SkyblockChunkGenerator extends ChunkGenerator {
    ...
    public SkyblockChunkGenerator(long seed, BiomeSource biomeSource, ChunkGeneratorType chunkGeneratorType) {
        super(biomeSource, biomeSource, chunkGeneratorType.getConfig(), seed);
        this.seed = seed;
    ...
    private static void generateStrongholdPortalInBox(ServerWorldAccess world, BlockPos pos, ChunkRandom random, Direction facing, BlockBox box) {
