    ...
    public static boolean checkGeodeFormation(World world, BlockPos lavaCenter) {
        return Blocks.LAVA.equals(world.getBlockState(lavaCenter).getBlock())
                ...
                Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.up(2)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.down(2)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                ...
                Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(0, 1, 1)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(0, 1, -1)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(0, -1, 1)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(0, -1, -1)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(1, 0, 1)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(1, 0, -1)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(-1, 0, 1)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(-1, 0, -1)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(1, 1, 0)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(1, -1, 0)).getBlock())
                && Blocks.SMOOTH_BASALT.equals(
                        world.getBlockState(lavaCenter.add(-1, 1, 0)).getBlock())
